<#
.SYNOPSIS
    N-Able: Automation Policy - Monitoring de l'installation SQL Server Compact (x64)
.DESCRIPTION
    N-Able: Automation Policy - Monitoring de l'installation SQL Server Compact (x64)
.NOTES
    Fichier    : nable.amp.sql-server-compact.x64.monitor.ps1
...
switch ($CPU_Arch) {
    ...
    "x64" {
        $IsInstalled = (Test-InstalledSoftware -SoftwareName "Microsoft SQL Server Compact 3.5 SP2 x64 ENU" -SoftwareVendor "Microsoft Corporation")
    }
}
