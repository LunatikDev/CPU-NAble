...
function Get-IPGeolocation {
    ...
    $GeoData = Invoke-RestMethod -Method Get -Uri "https://api.bigdatacloud.net/data/reverse-geocode-client?latitude=$Latitude&longitude=$Longitude&localityLanguage=fr"
    return $GeoData
}
...
$GeoData = Get-IPGeolocation -Latitude $pDeviceLatitude -Longitude $pDeviceLongitude
...
[string]$DeviceRegionAdm    = $GeoData.localityInfo.administrative[2].name
[string]$DeviceCity         = $GeoData.city
[string]$DeviceCountry      = $GeoData.countryName
...
[string]$DeviceLatitude  = $pDeviceLatitude
[string]$DeviceLongitude = $pDeviceLongitude
