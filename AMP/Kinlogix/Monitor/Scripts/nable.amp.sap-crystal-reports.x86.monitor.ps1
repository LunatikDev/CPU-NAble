<#
.SYNOPSIS
    N-Able: Automation Policy - Monitoring de l'installation SAP Crystal Reports (x86)
.DESCRIPTION
    N-Able: Automation Policy - Monitoring de l'installation SAP Crystal Reports (x86)
.NOTES
    Fichier    : nable.amp.sap-crystal-reports.x86.monitor.ps1
...
$IsInstalled = (Test-InstalledSoftware -SoftwareName "SAP Crystal Reports runtime engine for .NET Framework (32-bit)" -SoftwareVendor "SAP")
